      ...
      <div className='bg-[#ffffff8c] rounded-2xl shadow-lg border-2 border-[#ffffff4d] border-solid h-auto w-[35%] p-4 min-w-max'>
        ...
        <form className='pt-3' onSubmit={formik.handleSubmit}>
          <div className='profile flex justify-center py-1'>
            ...
            <img src={file || "./src/Components/Login&Signup/assests/profile.png"} className='border-4 border-gray-100 w-[135px] rounded-full shadow-lg cursor-pointer hover:border-gray-200' alt="avatar" />
            </label>
          ...
          <div className="textbox flex flex-col items-center gap-6 pt-5">
            ...
            <button className='border bg-indigo-500 w-full ssm:w-3/4 py-4 rounded-lg text-gray-50 text-xl shadow-sm text-center hover:bg-[#ff6a6a]' type='submit'>Sign In</button>
          </div>

          <div className="text-center py-4">
            <span className='text-gray-500'>Already Have An Account ? <Link className='text-red-500' to="/">Login
            </Link></span>
          </div>
