...
export default function Password() {
  ...
  return (
    <div className='flex justify-center bg-[url(./src/Components/Login&Signup/assests/Background.jpg)] bg-center h-auto lg:h-screen border-8 border-solid items-center py-10'>
