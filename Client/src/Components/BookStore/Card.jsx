        ...
        <>
            {book.map((item, index) => {
                ...
                if (thumbnail != undefined && amount != undefined) {
                    return (
                        <div key={index}>
                        <div key={index} className="bg-gray-200 p-2 m-1 duration-[0.5s] hover:shadow-sm hover:drop-shadow-sm hover:scale-90 rounded-xl" onClick={() => { setShow(true); setItem(item) }}>
